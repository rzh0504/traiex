...
> A minimal, beautiful, and customizable new tab page extension for Microsoft Edge.
...
- **💾 Sync + Local Storage** - Settings sync through your browser profile, while optional search history stays local
...
4. Click **Load unpacked** and select the `edge` folder
...
- **Browser Storage Sync API** - Cross-device settings sync
